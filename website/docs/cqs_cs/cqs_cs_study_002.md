...
```mermaid
flowchart TD
    Start[学習の目的は？] -->|最速でCQSを学びたい| Console[Console App🎮]
    Start -->|実務に近い形で学びたい| WebAPI[Minimal API🌐]
    Console --> Goal[CQSの基本とテストを習得！]
    WebAPI --> Goal
```
...
![Folder Structure](./picture/cqs_cs_study_002_folder_structure.png)
