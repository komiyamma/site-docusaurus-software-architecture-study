...
![CQS Separation Concept](./picture/cqs_cs_study_001_concept.png)
...
flowchart LR
  ...
  B -->|はい| C[Command🔧]
  B -->|いいえ| D[Query🔍]
  C --> C1[「世界が変わる」<br/>追加・更新・削除]
  D --> D1[「見るだけ」<br/>取得・検索・一覧]
```
...
![Hidden Side Effects](./picture/cqs_cs_study_001_hidden_side_effect.png)
